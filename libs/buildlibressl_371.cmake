# for libreSSL 3.7.1
# cmake -DCMAKE_GENERATOR="Visual Studio 17 2022" -DARCHITECTURE=Win32 -P buildlibressl_371.cmake
# cmake -DCMAKE_GENERATOR="Visual Studio 17 2022" -DARCHITECTURE=x64 -P buildlibressl_371.cmake
# cmake -DCMAKE_GENERATOR="Visual Studio 16 2019" -DARCHITECTURE=Win32 -P buildlibressl_371.cmake
# cmake -DCMAKE_GENERATOR="Visual Studio 15 2017" -P buildlibressl_371.cmake
# cmake -DCMAKE_GENERATOR="Visual Studio 15 2017" -DCMAKE_CONFIGURATION_TYPE=Release -P buildlibressl_371.cmake

include(script_support.cmake)

set(EXTRACT_DIR "${CMAKE_CURRENT_LIST_DIR}/build/libressl_371/src")
set(SRC_DIR "${EXTRACT_DIR}/libressl_3.7.1")
set(BUILD_DIR "${CMAKE_CURRENT_LIST_DIR}/build/libressl_371/build_${TOOLSET}")
set(INSTALL_DIR "${CMAKE_CURRENT_LIST_DIR}/libressl_371_${TOOLSET}")
...
execute_process(
  COMMAND ${CMAKE_COMMAND} -DTARGET=libressl371 -DEXT_DIR=${EXTRACT_DIR} -P download.cmake
)
